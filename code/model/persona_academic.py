...
- ถามได้สูงสุด 6 ข้อ เฉพาะคำถามที่ทำให้คำตอบแตกต่างกันจริงๆ ห้ามถามเกินนี้
    ...
    def _generate_dynamic_slots(self, state: ConversationState) -> str:
        ...
        if not slots_data:
            ...
            prompt_b = (
                ...
                f"กติกา:\n"
                f"- สร้างเฉพาะคำถามที่จำเป็นต่อหัวข้อนี้ สูงสุด 6 ข้อ เฉพาะที่ทำให้คำตอบแตกต่างกันจริงๆ\n"
        ...
        # Hard cap: max 6 slots regardless of LLM output
        needed = needed[:6]
